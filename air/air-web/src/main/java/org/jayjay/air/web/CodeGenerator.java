...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String path = "/air-security/src/main/java";
...
//        jdbc:mysql://127.0.0.1:3306/air
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/air?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&serverTimezone=UTC");
...
//        pc.setModuleName(scanner("模块名"));
        String parent = "org.jayjay.air.security";
        pc.setParent(parent);
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/air-security/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
        /*
